...
class _EmployeeListScreenState extends State<EmployeeListScreen> {
  ...
  Future<void> _loadEmployees() async {
    try {
      ...
      print(
          "Page: $currentPage, PageSize: $itemsPerPage, Search: $searchQuery");
  ...
  List<Employee> _getFilteredAndSortedEmployees() {
    ...
    if ((minHireDate != null && minHireDate!.isNotEmpty) ||
      ...
      filtered = filtered.where((emp) {
        ...
        if (minHireDate != null &&
            minHireDate!.isNotEmpty &&
            hireDate.compareTo(minHireDate!) < 0) return false;
        if (maxHireDate != null &&
            maxHireDate!.isNotEmpty &&
            hireDate.compareTo(maxHireDate!) > 0) return false;
        return true;
      }).toList();
    }
  ...
  Future<void> _deleteEmployee(Employee employee) async {
    try {
      ...
      ErrorMessages.show(context, e, title: "Error Deleting Employee");
    }
  }
                  ...
                  children: [
                    TextField(
                      decoration: InputDecoration(
                        hintText:
                            'Search employees by name, surname, or phone...',
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor:
                                showFilters ? Colors.orange : Colors.blue,
                            foregroundColor: Colors.white,
                          ),
                        ),
                        SizedBox(width: 16),
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: TextField(
                                      ...
                                      onChanged: (value) {
                                        _onHireDateRangeChanged(minHireDate,
                                            value.isNotEmpty ? value : null);
                                      },
                                    ),
                                  ),
                      ...
                      children: [
                        ...
                        DropdownButton<String>(
                          ...
                          items: [
                            ...
                            DropdownMenuItem(
                                value: 'surname', child: Text('Surname')),
                            DropdownMenuItem(
                                value: 'hireDate', child: Text('Hire Date')),
                            DropdownMenuItem(
                  ...
                  child: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed:
                            currentPage > 1 ? () => _onPageChanged(1) : null,
                      ),
                      IconButton(
