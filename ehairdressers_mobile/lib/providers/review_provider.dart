...
class ReviewProvider extends BaseProvider<Review> {
  ...
  Future<Review?> insertReview(Review review) async {
    try {
      ...
      var url = "https://10.0.2.2:7051/Review";
  ...
  Future<ReviewResponse?> submitReview(ReviewRequest request) async {
    try {
      ...
      List<String> endpoints = [
        "https://10.0.2.2:7051/Review",
        "https://10.0.2.2:7051/Review/submit",
        "https://10.0.2.2:7051/api/Review",
        "https://10.0.2.2:7051/api/Review/submit",
      ];
  ...
  Future<List<Review>> getServiceReviews(int serviceId) async {
    try {
      var url = "https://10.0.2.2:7051/Review/service/$serviceId";
      var uri = Uri.parse(url);
  ...
  Future<List<Review>> getEmployeeReviews(int employeeId) async {
    try {
      var url = "https://10.0.2.2:7051/Review/employee/$employeeId";
      var uri = Uri.parse(url);
  ...
  Future<bool> hasUserReviewed(int appointmentId, int userId) async {
    try {
      ...
      List<String> checkEndpoints = [
        "https://10.0.2.2:7051/Review/check/$appointmentId/$userId",
        "https://10.0.2.2:7051/Review/exists/$appointmentId/$userId",
        "https://10.0.2.2:7051/api/Review/check/$appointmentId/$userId",
      ];
  ...
  Future<List<Review>> getUserReviews(int userId) async {
    try {
      var url = "https://10.0.2.2:7051/Review/user/$userId";
      var uri = Uri.parse(url);
  ...
  Future<List<Review>> getAppointmentReviews(int appointmentId) async {
    try {
      var url = "https://10.0.2.2:7051/Review/appointment/$appointmentId";
      var uri = Uri.parse(url);
